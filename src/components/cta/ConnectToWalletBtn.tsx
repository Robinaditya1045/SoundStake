...
const ConnectWalletButton = () => {
  ...
  return (
    <div>
      <button onClick={connectToWallet} className='bg-blue-600 px-6 py-4 rounded-2xl'>
        {walletConnected ? `TronLink Wallet Connected: ${walletAddress}` : 'Connect TronLink Wallet'}
      </button>
      {!tronLinkInstalled && (
        <p></p>
      )}
